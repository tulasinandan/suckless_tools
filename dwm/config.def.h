...
/* appearance */
//static const char font[] = "-misc-fixed-medium-r-semicondensed--24-100-100-100-c-60-iso8859-1";
static const char font[] = "-misc-fixed-medium-r-semicondensed--20-100-*-*-*-*-*-*";
//static const char font[] = "-*-terminus-*-*-*-*-32-*-*-*-*-*-*-*";
//static const char font[] = "-xos4-*-*-*-*-*-24-*-*-*-*-*-*-*";
//static const char font[] = "Liberation Mono:pixelsize=24:antialias=true:autohint=true";
// static const char font[] = "DejaVu Sans Mono:style=Book:antialias=True:pixelsize=32";
...
/* tagging */
static const char *tags[] = { "www", "wrk", "wrk1", "opt", "etc" };
...
#endif
static const char *termcmd[]  = { "st", "-name", "tmux", "-T", "tmux", "-e", "tmux", NULL };
...
static Key keys[] = {
   ...
   { MODKEY,                       XK_comma,  focusmon,       {.i = -1 } },
	...
	{ MODKEY|Mod1Mask,              XK_Down,  spawn,          {.v = backlightdowncmd } },
	{ MODKEY|Mod1Mask,              XK_Up,    spawn,          {.v = backlightupcmd } },
